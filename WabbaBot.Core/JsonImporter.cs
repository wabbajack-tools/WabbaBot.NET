...
namespace WabbaBot.Core {
    public static class JsonImporter {
        public static async Task<bool> ImportJsonDb() {
            JArray serversData = JArray.Parse(File.ReadAllText(Path.Combine(@".\Old", "servers.json")));
            JArray modlistsData = JArray.Parse(File.ReadAllText(Path.Combine(@".\Old", "modlists.json")));
